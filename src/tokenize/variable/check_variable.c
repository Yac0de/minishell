...
/* This functions aims to convert a "word" extracted from the prompt line
that is or has within it an environment variable, like $USER or xxx$USER.
...
/* Will return 1 if the element is or has a variable ($VAR),
0 if it is not and -1 if we have unclosed quotes.
